 ...
 * @access		Private
 */
class PearInstallerStarterKit_DevelopementEntries extends PearStarterKit
{
	/**
	 * Starter kit UUID
	 * @var String
	 */
	var $starterKitUUID						=	"4fee4d2b-39a4-44d8-ada0-0303a9baf6a0";

	/**
	 * The starter kit name
	 * @var String
	 */
	var $starterKitName						=	"Development Entries";
	
	/**
	 * The starter kit description
	 * @var String
	 */
	var $starterKitDescription				=	"This starter-kit contains the information PearCMS development staff has used to to test out stuff and functionality.";
	 ...
	 * @var String
	 */
	var $starterKitVersion					=	"1.0.0";
	
	function initialize()
	{
		parent::initialize();
		$this->loadLanguageFile('lang_development_entries');
		
		$this->starterKitName				=	$this->lang['starter_kit__development_entries__name'];
		$this->starterKitDescription			=	$this->lang['starter_kit__development_entries__description'];
	}
