 ...
 * @access		Private
 */
class PearInstallerStarterKit_Default extends PearStarterKit
{
	/**
	 * Starter kit UUID
	 * @var String
	 */
	var $starterKitUUID						=	"4ebc60a0-39a0-48a0-8aa7-05aa9592128d";

	/**
	 * The starter kit name
	 * @var String
	 */
	var $starterKitName						=	"Basic";
	
	/**
	 * The starter kit description
	 * @var String
	 */
	var $starterKitDescription				=	"This is a basic (default) starter kit, it provides basic site template with the default configurations.";
	...
	{
		parent::initialize();
		$this->loadLanguageFile('lang_default');
	
		$this->starterKitName				=	$this->lang['starter_kit__basic__name'];
		$this->starterKitDescription			=	$this->lang['starter_kit__basic__description'];
	}
	...
	function createDemoContent()
	{
		...
		/* Yahav: I've made a simple pattern for creating starter kit
		 	just copy this method and modify the arrays bellow.
		 	I wish to create a "SDK export" option in the CP, But for now - this shall be good enough. */
...
EOF
				...
				array(
						...
						'layout_type'			=>	'directory',
						'layout_name'			=>	'Posts pages layout',
						'layout_author'			=>	'Quartz Technologies, LTD.',
						'layout_author_website'	=>	'http://pearcms.com',
						'layout_version'			=>	'1.0.0',
						'layout_content'			=>	<<<EOF
